...
const GSTNoticeSettings = () => {
  ...
  const handleAddField = async () => {
    try {
      ...
      setError("");
      message.success("Succesfully added new GST Notice Field");
    } catch (error) {
    ...
    <div>
      ...
      <div className="min-h-screen flex justify-center items-center bg-gray-100">
        <div className="max-w-2xl w-full bg-white p-8 rounded-md shadow-md mt-8 mb-8">
          ...
          <div className="mb-4">
            <label className="block mb-2">Field Description:</label>
            <input
              type="text"
...
export default GSTNoticeSettings;
